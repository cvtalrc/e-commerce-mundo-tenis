  ...
  return (<>
    {cartProducts != null &&
      <Box sx={{ width: 450, height: '87%' }}>
        ...
        <Box sx={{ position: 'absolute', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end', bottom: 0, width: '90%', paddingBottom: 1, pt: 2, borderTop: "thin solid gray", margin: '20px', pt: 2 }}>
        {totalPrice != null && (
