...
export default function Home() {
    ...
    return (
        <>
            <Box sx={{ bgcolor: "#f6f5f2", height: '50vh', marginTop: ".5rem", marginBottom: ".5rem", display: 'flex', justifyContent: 'center', width: '100vw', padding: 0 }}>
                <Typography
                    color='inherit'
                    sx={{ padding: 5 }}
                >Banner</Typography>
            ...
            <Container className="container-cards">
                <div className='sports-listCards'>
                    {products.map(({ id, title, brand, price, description, sport, category, imgUrl }) => <Card key={id} {...{ id, title, brand, price, description, sport, category, imgUrl }} />)}
