...
### 🧩 Arquitectura del sistema y flujo de pagos
Este diagrama muestra cómo interactúan los clientes, el servidor y la pasarela de pagos WebPay:

> **Diagrama de Arquitectura:**
>
> ![Arquitectura MVC](frontend/src/assets/Diagrama_de_flujo.png)
>
...
* **📦 Logística y stock:** Sistema de inventario con variantes (tallas, marcas) y cálculo automático de costos de envío.
