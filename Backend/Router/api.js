...
api.post("/cart/add", func_auth.authenticateAdmin, func_shoppingCart.addtoCart);
...
api.get("/order/", func_auth.authenticateAdmin, func_order.getAll);
...
api.put("/order/update/:id", func_auth.authenticateAdmin, func_order.updateOrderStatusAmdmin)
